...
class ApplicationAnalyzer:
    ...
    def _capture_summary(packets: list) -> CaptureSummaryResponse:
        ...
        return CaptureSummaryResponse(
            ...
            mean_packet_size=round(total_bytes / total_packets, 1) if total_packets else 0.0,
            protocol_counts=protocol_counts,
        )
def main():
    pcap_path = r"C:\Users\Avijit\Desktop\ESPect-main\testbed\dataset\pcaps\exp000001.pcap"
